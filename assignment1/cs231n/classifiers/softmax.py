...
def softmax_loss_naive(W, X, y, reg):
    ...
    # I am not really familiar with the Matrix derivative
    # refere to https://github.com/Divsigma/Courses/blob/master/cs231n/assignment1/cs231n/classifiers/softmax.py
    num_train = X.shape[0]
